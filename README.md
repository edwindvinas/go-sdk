...
Get SDK package:
```bash
go get -u github.com/edwindvinas/go-sdk@v1.2.0
```
...
```go
import "github.com/edwindvinas/go-sdk/servicev1"
...
import (
"fmt"
"github.com/edwindvinas/go-sdk/discoveryv1"
)
...
  discovery "github.com/edwindvinas/go-sdk/discoveryv1"
)
...
## Migrating
* To move from `v0.11.0` to `v1.0.0`, refer to the [MIGRATION-V1](https://github.com/edwindvinas/go-sdk/blob/master/MIGRATION-V1.md)
...
[examples]: https://github.com/edwindvinas/go-sdk/tree/master/examples
[CONTRIBUTING]: https://github.com/edwindvinas/go-sdk/blob/master/.github/CONTRIBUTING.md
